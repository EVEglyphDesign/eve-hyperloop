...
The two are dialectical. 006 fires when the agent asks too much; 007 fires when the agent asks too little. Convergence requires holding both simultaneously.
