...
```
[stamp 2026-05-21T21:50:00Z pplx-computer/this-thread-2026-05-21/T2 surface:pplx-computer seal world:unavailable:bootstrap tool:claude-sonnet-4-6@perplexity-computer]
```
...
- turn:           2 (monotonic this-thread commit-order; exact Perplexity turn id unavailable)
...
- platform-refs:
    ...
    - github:path/self-healing/repairs/007-button-suppression.md
