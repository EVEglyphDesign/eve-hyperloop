...
```
[stamp 2026-05-21T21:50:00Z pplx-computer/this-thread-2026-05-21/T1 surface:pplx-computer commit world:unavailable:bootstrap tool:claude-sonnet-4-6@perplexity-computer]
```
...
- turn:           1 (monotonic this-thread commit-order; exact Perplexity turn id unavailable)
...
- platform-refs:
    ...
    - github:path/self-healing/log/2026-05-21-2051-button-suppression-recurrence-sev-6.md
